...
CREATE TABLE CAT_TIENDAS(
    ID_TIENDA SERIAL NOT NULL UNIQUE,
...
ADD COLUMN ID_TIENDA INT,
ADD CONSTRAINT fk_tienda_ticket
FOREIGN KEY (ID_TIENDA) REFERENCES CAT_TIENDAS(ID_TIENDA);

ALTER TABLE DESCUENTO_ARTICULO
ADD COLUMN ID_TIENDA INT,
ADD CONSTRAINT fk_tienda_descuento
FOREIGN KEY (ID_TIENDA) REFERENCES CAT_TIENDAS(ID_TIENDA);

ALTER TABLE CAT_EXTRAS
ADD COLUMN ID_TIENDA INT,
ADD CONSTRAINT fk_tienda_extra
FOREIGN KEY (ID_TIENDA) REFERENCES CAT_TIENDAS(ID_TIENDA);

ALTER TABLE PAQUETE
ADD COLUMN ID_TIENDA INT,
ADD CONSTRAINT fk_tienda_paquete
FOREIGN KEY (ID_TIENDA) REFERENCES CAT_TIENDAS(ID_TIENDA);

ALTER TABLE CAT_ARTICULOS_VENTA
ADD COLUMN ID_TIENDA INT,
ADD CONSTRAINT fk_tienda_articulo
FOREIGN KEY (ID_TIENDA) REFERENCES CAT_TIENDAS(ID_TIENDA);
